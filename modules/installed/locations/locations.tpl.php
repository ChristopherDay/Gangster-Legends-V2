<?php
   ...
   class locationsTemplate extends template {
        ...
        public $locationsDelete = '
            <form method="post" action="?page=admin&module=locations&action=delete&id={id}&commit=1">
        ...
        public $locationsForm = '
            <form method="post" action="?page=admin&module=locations&action={editType}&id={id}">
